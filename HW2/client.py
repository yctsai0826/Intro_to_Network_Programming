...
class GamePlayer:
    ...
    def create_room(self):
        ...
        game_type = input("Enter game type (1: Tic-tac-toe, 2: Gomoku): ")
...
if __name__ == "__main__":
    ...
    login = False
    while True:
        # Example of setting a specific timeout for a particular operation
        # try:
        #     # Set a specific timeout for this response
        ...
        #     # Handle the timeout case (no data received within 1 second)
        #     pass
        # finally:
        #     # Reset timeout to default (blocking mode)
        #     player.client.settimeout(None)  # You can also set it to a different value if needed
